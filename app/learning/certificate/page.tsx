      ...
      >
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="mx-auto mt-14 max-w-3xl text-2xl leading-[2.2rem] text-zinc-300">
            ...
            BAKKER PFI Australia Passive Fire Knowledge Quiz
            and demonstrating a foundational understanding of
            passive fire protection,
            fire compartmentation,
            service penetrations,
            fire doors,
            AS1530.4 systems
            and passive fire compliance workflows.
          </p>
        </div>
        ...
        <div className="relative z-10 grid gap-10 border-t border-zinc-800 pt-10 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-lg text-zinc-400">
              Passive Fire Inspection & Compliance Systems
            </p>
          </div>
